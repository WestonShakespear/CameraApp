...
namespace testOne
{
    ...
    public class Texture
    {
        ...
        public void LoadFromFile(TextureUnit unit, string path)
        {
            // Generate handle
        ...
        public void LoadFromMemory(TextureUnit unit, byte[] image, int width, int height)
        {
            // Generate handle
            int handle = this.Handle;
           ...
           // this.startTimer();
            ...
            //GL.TexSubImage2D(TextureTarget.Texture2D, 0, 0, 0, width, height, PixelFormat.Rgba, PixelType.UnsignedByte, image.Data);
            // Now that our texture is loaded, we can set a few settings to affect how the image appears on rendering.
